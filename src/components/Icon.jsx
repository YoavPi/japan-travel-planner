...
/* ══════════════════════════════════════════════════════════════
   Icon — single SVG icon set (Lucide-style, stroke 1.75).

   Replaces emoji used as functional iconography across the SaaS
   per the PRODUCT.md "earned familiarity" principle. Emoji
   render inconsistently across OS / font versions; SVG renders
   identically and respects `color` from the parent (currentColor).
...
/* Each path is the inner content of an <svg viewBox="0 0 24 24">.
   Strokes use currentColor + the strokeWidth prop. fill="none"
   throughout — fills are only used for filled accent icons. */
const PATHS = {
  ...
  ruler: <><path d="M21.3 8.7l-6-6a1 1 0 0 0-1.4 0L2.7 13.9a1 1 0 0 0 0 1.4l6 6a1 1 0 0 0 1.4 0L21.3 10.1a1 1 0 0 0 0-1.4z" /><path d="M7 17l-1.5-1.5M10 14l-1.5-1.5M13 11l-1.5-1.5M16 8l-1.5-1.5" /></>,
  shield: <><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></>,
  helpCircle: <><circle cx="12" cy="12" r="10" /><path d="M9.1 9a3 3 0 0 1 5.8 1c0 2-3 3-3 3" /><line x1="12" y1="17" x2="12.01" y2="17" /></>,
  ...
  /* Sprint 56 — flat vector icons replacing native OS emojis on the main
     interface lines (3-colour scheme, currentColor-driven). */
  bed: <><path d="M2 4v16" /><path d="M2 8h18a2 2 0 0 1 2 2v10" /><path d="M2 17h20" /><path d="M6 8v-2a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v2" /></>,
  arrowUpDown: <><path d="M7 3v18" /><polyline points="3 7 7 3 11 7" /><path d="M17 21V3" /><polyline points="13 17 17 21 21 17" /></>,
  barChart: <><line x1="6" y1="20" x2="6" y2="12" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="18" y1="20" x2="18" y2="9" /></>,
  ...
  wrench: <><path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18v3h3l6.3-6.3a4 4 0 0 0 5.4-5.4l-2.6 2.6-2-2z" /></>,
