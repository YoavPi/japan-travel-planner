...
export const CITY_POOL = {
  ...
  it: ["רומא", "פירנצה", "ונציה", "מילאנו", "אמלפי", "נאפולי", "פיזה", "סיינה", "בולוניה", "ורונה", "טורינו", "פלרמו", "סורנטו", "צ׳ינקווה טרה", "קומו"],
  ...
  vn: ["האנוי", "הוי אן", "הו צ׳י מין", "חאלונג", "דה נאנג", "סאפא", "ניה טראנג", "הואה", "דלתת המקונג"],
...
/* Derived: Hebrew country name → destination id. The Google Places SDK is
   loaded with `language=he`, so autocomplete predictions come back
   Hebrew-localized — this maps those back to a curated id. */
export const COUNTRY_HE_TO_ID = DESTINATIONS.reduce((m, d) => { m[d.name] = d.id; return m; }, {});
